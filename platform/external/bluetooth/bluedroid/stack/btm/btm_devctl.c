...
void btm_dev_init (void)
{
    ...
    BTM_TRACE_DEBUG2("%s: bd_name = %s", __FUNCTION__, btm_cb.cfg.bd_name);
...
tBTM_STATUS BTM_SetLocalDeviceName (char *p_name)
{
    ...
    BTM_TRACE_DEBUG2("%s: name = %s", __FUNCTION__, p_name)
...
tBTM_STATUS BTM_ReadLocalDeviceName (char **p_name)
{
    ...
    *p_name = btm_cb.cfg.bd_name;
    BTM_TRACE_DEBUG2("%s: Local name is %s", __FUNCTION__, (char *)btm_cb.cfg.bd_name);
    return(BTM_SUCCESS);
#else
    *p_name = NULL;
    return(BTM_NO_RESOURCES);
